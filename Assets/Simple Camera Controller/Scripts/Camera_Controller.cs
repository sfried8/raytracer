...
public class Camera_Controller : MonoBehaviour
{
    ...
    private RayTracerHelper rayTracerHelper;

    void Start()
    {
        rayTracerHelper = FindObjectOfType<RayTracerHelper>();
    }
    ...
    void Update()
    {
        ...
        {
            rayTracerHelper.SaveScreenShot();
        }
        rayTracerHelper.shouldAccumulate = !Input.GetMouseButton(0) && Cam.magnitude == 0;
    }
